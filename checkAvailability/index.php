        ...
        <div class="modal-body">
          <div class="d-grid">
            <div class="row mb-2">
              ...
              >
              <div class="col-sm-8">
                <select class="select" id="editentryLocation"></select>
              </div>
            </div>
            <div class="row mb-2">
              <label
        ...
        <div class="main flex h-full">
          ...
          >
            <div class="pageTitle w-100 gap-3 d-flex">
              ...
              <h1 class="fw-semibold m-0">Dispatch Request</h1>
            </div>
            <div class="main w-100 d-flex h-[calc(100%-30px)]">
              <div class="left pr-0 lg:pr-6 py-6 pt-0">
                <div class="form">
                  <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                      <div class="h-100 d-flex align-items-center">
                        <input type="date" class="input ddates" id="endDate" />
                      </div>
                    </div>
                  </div>
                  <div class="mb-3 row">
              ...
              <div class="right h-full relative" id="appendHere">
                <div class="d-flex withContent d-none flex-column gap-3 h-full">
                  ...
                  <div class="flex flex-col empmoreDetails h-full gap-3">
                                ...
                                <li>
                                  ...
                                  >
                                    <span class="fw-medium"
                                      >Previous Year (<span id="y1"></span
                                      >)</span
                                    >
                                    <span class="totalDays" id="y1-days"></span>
                                  </div>
                                </li>
                                <li>
                                  <div
                                  ...
                                  >
                                    <span class="fw-medium"
                                      >Current Year (<span id="y2"></span
                                      >)</span
                                    >
                                    <span class="totalDays" id="y2-days"></span>
                                  </div>
                                </li>
                                <li>
                                  <div
                                  ...
                                  >
                                    <span class="fw-medium"
                                      >Next Year (<span id="y3"></span>)</span
                                    >
                                    <span class="totalDays" id="y3-days"></span>
                                  </div>
                                </li>
                              </ul>
                            </div>
                    ...
                    <div
                      class="d-flex totalThisYear flex-column shadow-sm p-3 gap-3"
                    >
                      <div class="label">
                    ...
                    <div class="dispatch-hist h-full pb-6 xl:pb-0">
                      ...
                      <div class="table-cont overflow-auto min-h-[200px]">
