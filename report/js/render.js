...
function createTable(repData) {
  ...
  Object.entries(repData).forEach(([key, groups]) => {
    ...
    groups.forEach((element) => {
      const ele = $(element.dispatch);
      const rspan = ele.length;
      ...
      if (rspan === 0) {
        str += `
          <tr>
            <td data-f-name="Arial" data-f-sz="9" data-a-h="center" data-a-v="middle" data-b-a-s="thin" data-b-a-c="000000" rowspan="1">${element.empName}</td>
            <td data-f-name="Arial" data-f-sz="9" data-a-h="center" data-a-v="middle" data-b-a-s="thin" data-b-a-c="000000" rowspan="1">${element.groupName}</td>
            <td data-f-name="Arial" data-f-sz="9" data-a-h="center" data-a-v="middle" data-b-a-s="thin" data-b-a-c="000000" rowspan="1">${element.visaExpiry || "-"}</td>
            <td data-f-name="Arial" data-f-sz="9" data-a-h="center" data-a-v="middle" data-b-a-s="thin" data-b-a-c="000000" rowspan="1">${element.reentryExpiry || "-"}</td>
        ...
        element.dispatch.forEach((dispData, index) => {
          const dDeets = index === 0 ? deets : "";
          const dTot = index === 0 ? tot : "";
