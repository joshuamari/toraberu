  ...
  <body>
    <div class="position-relative flex h-screen">
      ...
      <div class="content h-screen">
        ...
        <div class="main w-100 h-[calc(100%-45px)] flex flex-col gap-3 relative"id="appendHere">
          <div class=" selection w-100 d-flex align-items-center">
            ...
            <div>
              <button class="btn btn-success bg-[var(--darkest)] px-5 btn-export" id="btnExport">
                Export
              </button>
            </div>
          </div>
          ...
          <div
            class=" overflow-auto h-[calc(100%-55px)] relative" 
