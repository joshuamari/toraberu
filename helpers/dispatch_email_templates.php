...
/**
 * Outlook-safe HTML for Dispatch Request Approved emails.
 *
 ...
 * - khi_cta_url
 * - logo_url
 * - test_mode_placeholder (optional comment marker)
 */
function buildDispatchRequestApprovedEmailHtml(array $data): string
{
    ...
    $requestRef = (string)($data['request_ref'] ?? '');
                ...
                <tr>
                    <td style="padding:30px 34px 26px 34px;">
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;width:100%;margin-top:36px;">
                            ...
                            <tr>
                                <td style="font-size:13px;line-height:20px;color:#000000;padding:0 0 14px 0;">The dispatch request below has been reviewed and the status has been updated by the KDT President.</td>
                            </tr>
                            <tr>
                                <td style="font-size:13px;line-height:20px;color:#000000;padding:0;">The approved schedule is now confirmed.</td>
                            </tr>
                        </table>
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;margin-top:28px;background-color:#F9F9F9;border:1px solid #E9E9E9;border-radius:14px;border-collapse:separate;">
                            ...
                            <tr>
                                ...
                                <td width="50%" valign="top" style="width:50%;padding:14px 16px 14px 14px;border-bottom:1px solid #E9E9E9;">
                                    ...
                                    <div style="font-size:13px;line-height:18px;font-weight:700;color:#000000;word-break:break-word;">' . $requesterName . '</div>
                                </td>
                            </tr>
                            <tr>
                                                ...
                                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;width:100%;">
                                                    <tr>
                                                        <td align="center" bgcolor="#000000" style="background-color:#000000;border-radius:8px;">
                                                            <a href="' . $kdtCtaUrl . '" style="display:block;padding:12px 10px;font-family:Arial, Helvetica, sans-serif;font-size:12px;line-height:16px;font-weight:700;color:#FFFFFF;text-decoration:none;text-align:center;border-radius:8px;">View Dispatch Request&nbsp;&nbsp;&rarr;</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
...
/**
 * Outlook-safe HTML for Dispatch Request Declined emails.
 * Same layout/system as buildDispatchRequestApprovedEmailHtml(); status styling differs.
 *
 * Expected keys match the approved builder.
 */
function buildDispatchRequestDeclinedEmailHtml(array $data): string
{
    $requesterSurname = (string)($data['requester_surname'] ?? '');
    $employeeName = (string)($data['employee_name'] ?? '');
    $locationName = (string)($data['location_name'] ?? '');
