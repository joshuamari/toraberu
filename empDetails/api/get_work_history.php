...
try {
    ...
    $workHistory = getEmployeeWorkHistory(
        $connpcs,
        $connnew,
        $connkdt,
    ...
    jsonSuccess($workHistory, 'Work history loaded successfully.');
    ...
    error_log('empDetails/api/get_work_history.php failed: ' . $e->getMessage());
    jsonError('Failed to load work history.', 500);
}