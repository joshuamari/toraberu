...
function refreshPaginationIcons($container) {
  if (typeof lucide === "undefined" || typeof lucide.createIcons !== "function") {
    return;
  }

  const root = $container && $container.length ? $container.get(0) : undefined;
...
function renderPaginationBar($container, state) {
  ...
  refreshPaginationIcons($container);
